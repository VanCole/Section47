...
#include "S47BTTask_JetAcidePhase.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Enemy/Boss/S47BossDistance.h"

EBTNodeResult::Type US47BTTask_JetAcidePhase::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	if (!MyChar->isInPhase)
	{
		BBComp->SetValueAsBool(TEXT("JetAcidePhase"), false);
	}
